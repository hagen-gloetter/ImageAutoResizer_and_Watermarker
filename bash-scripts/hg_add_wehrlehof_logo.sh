...
# See www.gloetter.de
# Wehrlehof-Logo Watermark-Variante
...
# --- Wehrlehof-spezifische Wasserzeichen ---
...
WATERMARK_SW_L="$DIR_WATERMARK_IMAGES/gloetter_de_wasserzeichen_1100px.png"
WATERMARK_SW_M="$DIR_WATERMARK_IMAGES/gloetter_de_wasserzeichen_1100px.png"
WATERMARK_SW_S="$DIR_WATERMARK_IMAGES/gloetter_de_wasserzeichen_1100px.png"
...
for FN in *.jpg *.jpeg *.JPG *.JPEG *.HEIC *.heic; do
    ...
    # Wehrlehof: SouthEast-Logo immer, SouthWest bei HG im Dateinamen
    ...
    case "$FN" in *HG*)
        ...
        "$COMPOSITE" -gravity SouthWest -geometry +"$OFFSET_WATERMARK_X"+"$OFFSET_WATERMARK_Y" \
            "$WATERMARK_SW" "$FQFN_6k" "$FQFN_6k"
        ;;
    *) ;;
    esac
